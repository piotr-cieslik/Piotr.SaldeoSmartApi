namespace Piotr.SaldeoSmartApi
{
    public static class Paths
    {
        ...
        {
            public const string Version0 = "/api/xml/1.0/contractor/merge";
        }
        ...
        {
            public const string Version0 = "/api/xml/1.0/document/add";
        }
        ...
        {
            public const string Version0 = "/api/xml/1.0/contractor/list";
        }
        ...
        {
            public const string Version0 = "/api/xml/1.0/category/merge";
        }
        ...
        {
            public const string Version0 = "/api/xml/1.0/register/merge";
        }
        ...
        {
            public const string Version0 = "/api/xml/1.0/payment_method/merge";
        }
        ...
        {
            public const string Version0 = "/api/xml/1.0/company/synchronize";
        }
        ...
        {
            public const string Version14 = " /api/xml/1.14/article/merge";
        }
    }
}
